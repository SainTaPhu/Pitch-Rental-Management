using UnityComplex.Models.Payments;
...
namespace UnityComplex.Services
{
    public class VnPayService : IVnPayService
    {
        ...
        public string CreateRequestUrl(HttpContext context, VnPaymentRequestModel model)
        {
            ...
            vnpay.AddRequestData("vnp_CreateDate", model.CreatDate.ToString("yyyyMMddHHmmss"));
            ...
            {
                vnpay.AddRequestData("vnp_ReturnUrl", _config["VnPay:PaymentRemainBackReturnUrl"]);
            }
